<template>
  ...
  <el-col :span="6"><div class="grid-content bg-purple-light"><el-menu style="bottom:-13px" :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
