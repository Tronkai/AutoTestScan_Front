<template>
    ...
    <div id="runcase">
      <el-container style="width:1200px;margin: auto; left:0; top:0; right:0; bottom:0; border-left: solid 0px #e6e6e6">
     ...
     <el-container>
      ...
      <el-menu :default-openeds="['2','3','4']" :router="true"  active-text-color="#42b983" style="margin-top:20px;border-right: solid 0px #e6e6e6;border-left: solid 0px #e6e6e6">
        <el-submenu index="2">  
          ...
          <el-menu-item-group>
             <el-menu-item index="/runtronscanui">TRONSCAN UI</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
